                            	...
                            	<tr>
                                    ...
                                    <td >
                                        <select class="form-control" name="date" id="distribut_date">
                                                <?php $__FOR_START_1005004756__=1;$__FOR_END_1005004756__=31;for($i=$__FOR_START_1005004756__;$i < $__FOR_END_1005004756__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($config[date] == $i): ?>selected="selected"<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                                        </select>
                                    </td>
